...
<html>
    <head>
		...
		<!-- usage block -->
        <link rel="stylesheet" type="text/css" href="<?php get_theme_url(); ?>/css/usage.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php get_theme_url(); ?>/css/jquery.fancybox.css" />
        <!-- usage block end -->
    </head>
    <body>
...
get_page_content(); 
include 'php/collectionUsage.php';
?>
    ...
    <script src="<?php get_theme_url(); ?>/js/usage.js"></script>
</html>
