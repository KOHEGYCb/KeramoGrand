...
$i18n = array(
  ...
  , 'CONFIGURATION' => "Настройки поиска"
  ...
  , 'CUSTOMIZE_2' => "страницы и/или добавить параметры поиска в код"
  ...
  , 'PLACEHOLDER_DESCR' => "Текст в поле формы поиска"
  ...
  , 'IDPREFIX_DESCR' => "Если вы установите этот параметр, каждый результат поиска будет получать идентификатор с этим префиксом и с числом по возрастанию"
  , 'TAGCLASSPREFIX_DESCR' => "Этот параметр создает класс для каждого результата поиска в соответствии со всеми тегами данной страницы."
  ...
  , 'MARK' => "Отметить искомые слова на страницах"
);